...
// <![CDATA[
  ...
  * DO NOT EDIT BELOW THIS BOX *
  ...
  function activarAnimacion() {
    ...
    var anim = config.ad;
    var activaDesactivar2 = localStorage.getItem("infoJugador2");
    var config2 = JSON.parse(activaDesactivar2); 
    var anim2 = config2.ad;
    if (anim === "si" || anim2 === "si") {
      addLoadEvent(september_21);
    } 
  }
  
  // Para activar la animación, llama a la función:
  activarAnimacion();
